/**
 * KRN-02 service errors. Shape matches `ErrorResponseSchema`
 * (`@mahisys/shared`). Duplicated from KRN-01's identical class rather
 * than imported cross-module, consistent with Vol 6 §7 ("a module
